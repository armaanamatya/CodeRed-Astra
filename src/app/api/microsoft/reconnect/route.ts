...
export async function GET(request: NextRequest) {
  try {
    ...
    microsoftAuthUrl.searchParams.set('scope', 'https://graph.microsoft.com/calendars.readwrite https://graph.microsoft.com/mail.readwrite https://graph.microsoft.com/user.read offline_access');
